...
const NewChatSearch: React.FC<ISearchCardProps> = ({
  setSearchCard,
}) => {
 ...
 await axios.post('http://localhost:5000/create-new-chat',{participantId},
    {
        headers:{
      ...
      >
        <div className="relative p-4 w-full max-w-md max-h-full">
          <div className="relative bg-sidebarBlack rounded-lg shadow dark:bg-gray-700">
            ...
            <div className='flex justify-center mt-3 w-[95%] ml-2 gap-2'><input value={searchName} onChange={(e)=>setSearchName(e.target.value)} className='bg-black rounded-full w-full border-none text-white' placeholder='Search...' type="text" name="" id="" />
            <div
            ...
            <div className="p-4 md:p-5">
              ...
              {noUsers? (
                ...
                users.map((user, index) => (
                  <Link href='#'onClick={()=>handleNewChat(user._id)}>
